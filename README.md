...
### The Modeler
- **Info Panel** — model presentation metadata: Name, Rule Author, GenesisCA Project Author, Description, tags, and an optional **Thumbnail** (PNG/JPEG/GIF/WebP up to 2 MB — shown on hover in the Models Library)
