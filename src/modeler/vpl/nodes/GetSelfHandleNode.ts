 ...
 *  value so the agent can pass ITS OWN id to the by-id nodes (Get/Set Agent
...
export const GetSelfHandleNode: NodeTypeDef = {
  ...
  description: "Outputs the current agent's own handle (its id) — pass it to the by-id nodes (Get/Set Agent Attribute, Get Agent Position, Form Bond, …).",
  category: 'data',
  color: '#5e35b1',
