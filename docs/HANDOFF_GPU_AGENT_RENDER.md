...
| E unified device | READY — handoff written ([HANDOFF_GPU_AGENT_RENDER_E.md](HANDOFF_GPU_AGENT_RENDER_E.md)), split E1 (device unification + zero-copy field bridge) / E2 (single-canvas composite + 3D lift) | — | refined from D's report |
