...
**Scope:** 120 registry node types across 7 categories (event, flow, data, logic, aggregation,
output, color) — 3 hidden from the Add Node menu (`macro` / `macroInput` / `macroOutput`),
leaving **117 selectable** (Agent Capability Profiles added **Get Age** [Lifespan] + **Get
Agents In View** [Sensing — the directional vision cone]). Indicator
